import{_ as x,D as O,M as S,r as M,s as L,t as b,P as q,k as P,v as _,w as R,V as F}from"./VTable-BcKhBwh1.js";import{T as N,V as w}from"./VDivider-DYTqw6Rb.js";import{aA as B,au as Y,az as r,av as e,at as l,aD as C,Y as p,aC as t,aB as c,f as v,ax as k}from"./index-CEhUQlg2.js";const E=["The State Variable Filter will resonate and cutoff around a set frequency.",`Connect audio from the outside world into the grid.
...
Tap in a tempo, open up a VCA, trigger a sequencer, or anything else.
The grid is your oyster!`,"","","","Load or record your favourite sample, chop it up, then play it back at any speed/pitch your heart desires. All samples must be mono or stereo PCM WAV files that are 10 minutes or less in length.","Perform logical operations with CV inputs. Operations include: AND, OR, NOT, NOR, NAND, XOR, XNOR.","An 8 channel CV Mixer and attenuverter.","","This delay effect lets you twist time with reversed, pitch shifted repeats.","Classic vibe sound with some added versatility."],z={computed:{DISPLAY_BLOCK(){return O},MODULES(){return S.map((o,a)=>({m:o,category:M[o.category],tip:N[a],description:E[a],bes:L(o.blocks).map(i=>{const g=i[1].param?b(i[0],o):void 0,h=i[1].param?q[g]:void 0;return[...i,P[_(i,o.id)],i[1].param?R[b(i[0],o)]:"-",i[1].param?(Array.isArray(h[0])?h:[h]).map(s=>`${s[0]}/${s[1]}${s[2]?" "+s[2]:""}`).join(", "):null]})})).sort((o,a)=>o.m.category-a.m.category)}}},G={class:"text-no-wrap g-bolder"},U={class:"text-right"},Z={class:"text-right"},j={class:"g-bold"},W={class:"text-no-wrap"},H={key:0},K={class:"pt-2 pl-8 pb-2",style:{"vertical-align":"top"},colspan:"2"},$=["rowspan"],X={class:"text-right"},Q={class:"g-bold"},J={class:"text-no-wrap"};function ee(o,a,i,g,h,s){return r(),B(F,{density:"compact"},{default:Y(()=>[a[1]||(a[1]=e("thead",null,[e("tr",null,[e("th",null,"Module"),e("th",null,"Category"),e("th",null,"Euro"),e("th",null,"Input"),e("th",null,"Conditional"),e("th",{class:"text-right"}," CPU "),e("th",{class:"text-right"}," Position "),e("th",null,"Display"),e("th",null,"Block"),e("th",null,"Type"),e("th",null,"Param"),e("th",null,"Initial")])],-1)),e("tbody",null,[(r(!0),l(p,null,C(s.MODULES,({m:u,category:V,description:m,tip:f,bes:n})=>(r(),l(p,{key:u.id},[e("tr",null,[e("td",G,t(u.name),1),e("td",null,t(V),1),e("td",null,t(u.euro),1),e("td",null,t(u.in),1),e("td",null,t(!!u.conditions||void 0),1),e("td",U,t(u.cpu),1),e("td",Z,t(n[0][1].position)+". ",1),e("td",null,t(s.DISPLAY_BLOCK[n[0][0]]),1),e("td",j,t(n[0][0]),1),e("td",null,t(n[0][2]),1),e("td",W,[e("b",null,t(n[0][3]),1),c(" "+t(n[0][4]),1)]),e("td",null,t(n[0][1].initial),1)]),n.slice(1).length===0?(r(),l("tr",H,[e("td",K,[c(t(f)+" ",1),v(w,{class:"my-2"}),c(" "+t(m||"[UNDEFINED]"),1)]),a[0]||(a[0]=e("td",{colspan:"10"},null,-1))])):k("",!0),(r(!0),l(p,null,C(n.slice(1),([d,y,I,A,D],T)=>(r(),l("tr",{key:d},[T?k("",!0):(r(),l("td",{key:0,class:"pt-2 pl-8 pb-2",style:{"vertical-align":"top"},rowspan:n.length-1,colspan:"6"},[c(t(f)+" ",1),v(w,{class:"my-2"}),c(" "+t(m||"[UNDEFINED]"),1)],8,$)),e("td",X,t(y.position)+". ",1),e("td",null,t(s.DISPLAY_BLOCK[d]),1),e("td",Q,t(d),1),e("td",null,t(I),1),e("td",J,[e("b",null,t(A),1),c(" "+t(D),1)]),e("td",null,t(y.initial),1)]))),128))],64))),128))])]),_:1})}const ae=x(z,[["render",ee]]);export{ae as default};

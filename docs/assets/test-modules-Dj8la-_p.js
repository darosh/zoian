import{_ as D,D as A,M as T,s as x,t as O,k as S,v as M,w as L,V as q}from"./VTable-B_laHkhP.js";import{T as P,V as y}from"./VDivider-BCPBvOed.js";import{aA as F,au as R,az as i,av as e,at as r,aD as b,Y as d,aC as t,aB as l,f as w,ax as C}from"./index-TIFBF-Gd.js";const _=["The State Variable Filter will resonate and cutoff around a set frequency.",`Connect audio from the outside world into the grid.
...
Tap in a tempo, open up a VCA, trigger a sequencer, or anything else.
The grid is your oyster!`,"","","","Load or record your favourite sample, chop it up, then play it back at any speed/pitch your heart desires. All samples must be mono or stereo PCM WAV files that are 10 minutes or less in length.","Perform logical operations with CV inputs. Operations include: AND, OR, NOT, NOR, NAND, XOR, XNOR.","An 8 channel CV Mixer and attenuverter.","","This delay effect lets you twist time with reversed, pitch shifted repeats.","Classic vibe sound with some added versatility."],B={computed:{DISPLAY_BLOCK(){return A},MODULES(){return T.map((a,n)=>({m:a,category:x[a.category],tip:P[n],description:_[n],bes:O(a.blocks).map(u=>{const{param:p}=u[1];return[...u,S[M(u,a.id)],p?L(u[0],a):void 0]})})).sort((a,n)=>a.m.category-n.m.category)}}},N={class:"text-no-wrap g-bolder"},Y={class:"text-right"},E={class:"text-right"},z={class:"g-bold"},U={key:0},G={class:"pt-2 pl-8 pb-2",style:{"vertical-align":"top"},colspan:"2"},Z=["rowspan"],j={class:"text-right"},W={class:"g-bold"};function H(a,n,u,p,K,c){return i(),F(q,{density:"compact"},{default:R(()=>[n[1]||(n[1]=e("thead",null,[e("tr",null,[e("th",null,"Module"),e("th",null,"Category"),e("th",null,"Euro"),e("th",null,"Input"),e("th",null,"Conditional"),e("th",{class:"text-right"}," CPU "),e("th",{class:"text-right"}," Position "),e("th",null,"Display"),e("th",null,"Block"),e("th",null,"Type"),e("th",null,"Param"),e("th",null,"Initial")])],-1)),e("tbody",null,[(i(!0),r(d,null,b(c.MODULES,({m:s,category:v,description:g,tip:m,bes:o})=>(i(),r(d,{key:s.id},[e("tr",null,[e("td",N,t(s.name),1),e("td",null,t(v),1),e("td",null,t(s.euro),1),e("td",null,t(s.in),1),e("td",null,t(!!s.conditions||void 0),1),e("td",Y,t(s.cpu),1),e("td",E,t(o[0][1].position)+". ",1),e("td",null,t(c.DISPLAY_BLOCK[o[0][0]]),1),e("td",z,t(o[0][0]),1),e("td",null,t(o[0][2]),1),e("td",null,t(o[0][3]),1),e("td",null,t(o[0][1].initial),1)]),o.slice(1).length===0?(i(),r("tr",U,[e("td",G,[l(t(m)+" ",1),w(y,{class:"my-2"}),l(" "+t(g||"[UNDEFINED]"),1)]),n[0]||(n[0]=e("td",{colspan:"10"},null,-1))])):C("",!0),(i(!0),r(d,null,b(o.slice(1),([h,f,k,V],I)=>(i(),r("tr",{key:h},[I?C("",!0):(i(),r("td",{key:0,class:"pt-2 pl-8 pb-2",style:{"vertical-align":"top"},rowspan:o.length-1,colspan:"6"},[l(t(m)+" ",1),w(y,{class:"my-2"}),l(" "+t(g||"[UNDEFINED]"),1)],8,Z)),e("td",j,t(f.position)+". ",1),e("td",null,t(c.DISPLAY_BLOCK[h]),1),e("td",W,t(h),1),e("td",null,t(k),1),e("td",null,t(V),1),e("td",null,t(f.initial),1)]))),128))],64))),128))])]),_:1})}const J=D(B,[["render",H]]);export{J as default};

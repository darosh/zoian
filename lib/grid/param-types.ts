...
export const TYPE_MAP: Record<string, (TypeSpec | TypesSpec)[]> = {
  ...
  tap_tempo_in: [
    ...
    { type: ParamType.Ignored, modules: ['Reverse Delay'] },
    { type: ParamType.Ignored, modules: ['Ping Pong Delay'] },
    { type: ParamType.Ignored, modules: ['Vibrato', 'Univibe'] },
    { type: ParamType.Ignored, modules: ['Flanger', 'Chorus'] },
    { type: ParamType.Ignored, modules: ['Delay w/ Mod'] },
